...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20240705161926_Initial")]
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8975),
                            DateDeleted = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8985),
                            DateUpdated = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8985),
                            Guid = new Guid("cefb9367-d3cf-4f15-ab24-e19c3327f174"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8987),
                            DateDeleted = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8988),
                            DateUpdated = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8988),
                            Guid = new Guid("5e13b30f-cb98-409a-bd96-881de318edb0"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8989),
                            DateDeleted = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8990),
                            DateUpdated = new DateTime(2024, 7, 5, 19, 19, 25, 668, DateTimeKind.Local).AddTicks(8989),
                            Guid = new Guid("11c325c3-be1e-413c-96f3-e17e0e8a1eaa"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
