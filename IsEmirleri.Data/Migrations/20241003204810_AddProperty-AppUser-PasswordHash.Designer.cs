...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20241003204810_AddProperty-AppUser-PasswordHash")]
    partial class AddPropertyAppUserPasswordHash
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3869),
                            DateDeleted = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3884),
                            DateUpdated = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3884),
                            Guid = new Guid("0f0ab414-16fb-4f1c-a684-bdc82e44d097"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3888),
                            DateDeleted = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3889),
                            DateUpdated = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3888),
                            Guid = new Guid("2f4f40e3-e1de-4237-9f26-39ed082d5040"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3891),
                            DateDeleted = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3892),
                            DateUpdated = new DateTime(2024, 10, 3, 23, 48, 10, 208, DateTimeKind.Local).AddTicks(3891),
                            Guid = new Guid("cefd8173-267b-4415-8561-475ed3583a73"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
