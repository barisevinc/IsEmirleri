...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20240921175613_StartTimeRelational")]
    partial class StartTimeRelational
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6651),
                            DateDeleted = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6664),
                            DateUpdated = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6663),
                            Guid = new Guid("4681d24f-8d28-46a0-9c7b-27a4c37ac9b7"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6674),
                            DateDeleted = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6675),
                            DateUpdated = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6674),
                            Guid = new Guid("7128ee4c-b086-46d5-84f7-0ec16a725c4d"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6677),
                            DateDeleted = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6678),
                            DateUpdated = new DateTime(2024, 9, 21, 20, 56, 13, 258, DateTimeKind.Local).AddTicks(6677),
                            Guid = new Guid("6f2b84a9-bea0-4f6b-a2d3-f7dccede8662"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
