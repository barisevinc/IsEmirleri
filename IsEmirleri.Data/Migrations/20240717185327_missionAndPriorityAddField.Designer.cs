...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20240717185327_missionAndPriorityAddField")]
    partial class missionAndPriorityAddField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8165),
                            DateDeleted = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8182),
                            DateUpdated = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8181),
                            Guid = new Guid("d874f59d-5772-4ed1-803f-e99c53357397"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8186),
                            DateDeleted = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8187),
                            DateUpdated = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8186),
                            Guid = new Guid("60e5b455-214e-4997-a0f5-73581843085f"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8189),
                            DateDeleted = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8190),
                            DateUpdated = new DateTime(2024, 7, 17, 21, 53, 26, 641, DateTimeKind.Local).AddTicks(8189),
                            Guid = new Guid("468bf18e-25dd-4e5c-8568-c2c6cb5e3833"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
