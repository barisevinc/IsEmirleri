...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20240708184513_AppUserAndCustomerTableFieldUpdate")]
    partial class AppUserAndCustomerTableFieldUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3216),
                            DateDeleted = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3234),
                            DateUpdated = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3233),
                            Guid = new Guid("b3a4722f-7943-4f3a-adf1-1f3c68aefbdd"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3242),
                            DateDeleted = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3243),
                            DateUpdated = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3243),
                            Guid = new Guid("ac40f9a7-bcb7-48fa-b3fa-d4b668eb5b7a"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3248),
                            DateDeleted = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3249),
                            DateUpdated = new DateTime(2024, 7, 8, 21, 45, 12, 312, DateTimeKind.Local).AddTicks(3248),
                            Guid = new Guid("151303cb-afb4-41f4-a9f6-4db10f1dd928"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
