...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20241004131017_passwordhashnullabe")]
    partial class passwordhashnullabe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9425),
                            DateDeleted = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9435),
                            DateUpdated = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9434),
                            Guid = new Guid("2c04751b-50c3-4ee6-b933-8d25dad34b2a"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9442),
                            DateDeleted = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9443),
                            DateUpdated = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9442),
                            Guid = new Guid("8115616e-8db4-4ea3-9dc2-4fdf9e3d2a45"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9444),
                            DateDeleted = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9445),
                            DateUpdated = new DateTime(2024, 10, 4, 16, 10, 17, 119, DateTimeKind.Local).AddTicks(9445),
                            Guid = new Guid("7a00eb57-d5ec-4920-90b6-c2b5a0f44dfc"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
