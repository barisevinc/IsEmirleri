...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20240922170128_MissionIsCompleted")]
    partial class MissionIsCompleted
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(136),
                            DateDeleted = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(145),
                            DateUpdated = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(144),
                            Guid = new Guid("f877766e-aece-477c-bc22-623d2facfd85"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(156),
                            DateDeleted = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(156),
                            DateUpdated = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(156),
                            Guid = new Guid("6a4ce9a5-7552-4926-a427-9db827c963e1"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(159),
                            DateDeleted = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(159),
                            DateUpdated = new DateTime(2024, 9, 22, 20, 1, 27, 588, DateTimeKind.Local).AddTicks(159),
                            Guid = new Guid("f1f57240-bcee-433a-839a-0f44d0ed645e"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
