...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20240713105940_addField")]
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6327),
                            DateDeleted = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6342),
                            DateUpdated = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6341),
                            Guid = new Guid("fc901be9-8ad9-4b3d-9e82-8d6e3a80b068"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6365),
                            DateDeleted = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6365),
                            DateUpdated = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6365),
                            Guid = new Guid("66482fd9-e0a7-4578-9aeb-5daf80ae025a"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6368),
                            DateDeleted = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6369),
                            DateUpdated = new DateTime(2024, 7, 13, 13, 59, 39, 861, DateTimeKind.Local).AddTicks(6368),
                            Guid = new Guid("b0de142e-b59d-4f5c-bef2-0c3615f5f3c5"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
