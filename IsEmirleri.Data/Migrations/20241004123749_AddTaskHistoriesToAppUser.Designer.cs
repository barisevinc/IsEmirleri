...
namespace IsEmirleri.Data.Migrations
{
    ...
    [Migration("20241004123749_AddTaskHistoriesToAppUser")]
    partial class AddTaskHistoriesToAppUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("IsEmirleri.Models.AppUserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7380),
                            DateDeleted = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7424),
                            DateUpdated = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7424),
                            Guid = new Guid("294c8d02-1c44-4469-9d57-c2358929b934"),
                            IsDeleted = false,
                            Name = "Superadmin"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7426),
                            DateDeleted = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7427),
                            DateUpdated = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7426),
                            Guid = new Guid("4f3bfe0a-4bd9-40d2-be62-1e26dbb8116a"),
                            IsDeleted = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7428),
                            DateDeleted = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7429),
                            DateUpdated = new DateTime(2024, 10, 4, 15, 37, 49, 548, DateTimeKind.Local).AddTicks(7428),
                            Guid = new Guid("a8604e81-58f7-48ec-86e4-7209856c2afc"),
                            IsDeleted = false,
                            Name = "User"
                        });
                });
